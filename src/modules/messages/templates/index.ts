    ...
    return `
        <div class="flex flex-col items-center space-y-3">
            ...
            ${ selfCall || user.stats.time.public ? `
                            <div class="w-full relative flex flex-col space-y-1 px-4 py-3 items-center rounded-xl shadow-md bg-[#202225] ${user.stats.time.public ? 'opacity-100' : selfCall ? 'opacity-100' : 'opacity-70'}">
